...
class WifiMonitorApp(tk.Tk):
    ...
    def _build_ui(self) -> None:
        ...
        help_text.insert(
            ...
            "5. Pilih backend speedtest. Gunakan Ookla CLI jika ingin hasil lebih dekat ke aplikasi resmi Speedtest.\n"
            "6. Tambahkan SSID Wi-Fi, password, dan nama di laporan jika ingin tes Wi-Fi juga. Nama di laporan akan tampil di kolom Wi-Fi pada Excel/PDF.\n"
            "7. Icon mata menampilkan password, icon mata dicoret menyembunyikan password kembali.\n"
            "8. Klik Simpan Config.\n\n"
            "Tes manual:\n"
